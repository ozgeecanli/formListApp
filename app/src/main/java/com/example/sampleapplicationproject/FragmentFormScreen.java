...
public class FragmentFormScreen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        courseNameEdt = setContentView.findViewById(R.id.editTextFormName);
        courseDescEdt = setContentView.findViewById(R.id.editTextFormSurname);
        addBtn = setContentView.findViewById(R.id.buttonFormSave);
        courseRV = setContentView.findViewById(R.id.recyclerViewNameSurname);
